...
public class AdminServiceImpl implements AdminService {
    ...
    public InventoryResponse adjustStock(InventoryRequest request) {
        ...
        InventoryItem inventory = inventoryItemRepository
                .findByBookIdAndBranchId(request.getBookId(), request.getBranchId())
    ...
    public void markBookUnusable(Long bookId, Long branchId, int quantity) {
        ...
        InventoryItem inventory = inventoryItemRepository
                .findByBookIdAndBranchId(bookId, branchId)
    ...
    public List<AuthorResponse> listAuthors() {
        ...
        return authorRepository.findAll()
                .stream()
                .map(a -> new AuthorResponse(a.getId(), a.getName(), a.getBiography()))
                .toList();
    }
    ...
    private InventoryResponse mapInventory(InventoryItem inventory) {
